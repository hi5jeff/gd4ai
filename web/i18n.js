...
const I18N = {
  zh: {
    logo: 'gd4.ai',
    eyebrow: '精选 AI 工具生态',
    heroPre: '说出你想做的事，得到一套',
    heroAccent: '神奇的 AI 方案',
    lead: 'Vibe Coding 时代，不需要懂代码，只需要懂你的意图。我们为你搭配最适合的 AI 组合，让想法直接落地。',
    subtitle: '说出你想做的事，得到一套能直接跑通的 AI 工具方案',
    placeholder: '我想做一个电商品牌…',
    btn: '施展魔法',
  ...
  en: {
    ...
    heroPre: 'Tell us what you want —',
    heroAccent: 'get a magical AI stack',
    lead: "In the vibe-coding era you don't need to write code — just your intent. We assemble the AI stack that makes your idea real.",
    subtitle: 'Tell us what you want to build. Get an AI tool stack that actually runs.',
    placeholder: 'I want to build an e-commerce brand…',
    btn: 'Cast Magic',
